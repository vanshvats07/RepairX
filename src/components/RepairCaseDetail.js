...
import RepairCaseActions from "@/components/RepairCaseActions";
...
export default function RepairCaseDetail({ caseId, user }) {
  ...
  async function refreshCase() { await load(); }
  return <main className="data-shell">
    ...
    <RepairCaseActions request={request} quote={quote} user={user} onChanged={refreshCase} />
